...
<a href="logout.php" style="margin-left: 670px" class="btn btn-primary" style="color: White;">Logout</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Register New Truck</h4>
      ...
      <div class="modal-body">
        ...
        <span id="tname_error" class="validu"> </span>
        </div>
...
function addTruck()
{
  ...
  if(truckName=="")
  {
    document.getElementById('tname_error').innerHTML="This Field is required";
    return false;
  }
  ...
  if (truckName!="") 
  {
    ...
    {
      document.getElementById('tname_error').innerHTML="Only alphabets are allowed!";
    return false;
    }
  }
  ...
  if(truckNumber=="")
  {
    document.getElementById('tnumber_error').innerHTML="This Field is required";
    return false;
  }
  if (truckNumber!="") 
  {
  ...
  {
    document.getElementById('tstatus_error').innerHTML="This Field is required";
    return false;
  }
