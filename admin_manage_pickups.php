...
<a href="logout.php" style="margin-left: 650px" class="btn btn-primary" style="color: White;">Logout</a>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        ?>
                ...
                <span id="uEmp_error" class="validu"></span>
      ...
      <div class="form-group">
        ...
        <?php
        $trucku=mysqli_query($con,"select truck_name from tbl_truck");
        ...
        ?>
                ...
                <span id="uTruck_error" class="validu"></span>
...
while($getLoc=mysqli_fetch_array($loc))
{
  ...
  <?php
        ...
        ?>
                ...
                <span id="uLoc_error" class="validu"></span>
        </div>
<!--
        <div class="form-group">
        ...
        <input type="datetime-local" name="update_date" id="update_date" class="form-control" />
                <span id="uDate_error" class="validu"></span>
